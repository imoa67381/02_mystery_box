...
class Start:
    def __init__(self, parent):
        ...
        mystery_instructions = "Please enter a dollar amount (between $5 and $50) in the box " \
                               "below. Then click the 'Add Funds'button and choose the stakes " \
                               "the higher the stakes " \
                               "the the more you can win!"
    ...
    def to_game(self, stakes):
        ...
        try:
            ...
            if starting_balance < 5:
                ...
                has_errors = "yes"
                error_feedback = "Sorry you can only afford to " \
                                 "play a low or a medium stakes game."
...
class Game:
    def __init__(self, partner, stakes, starting_balance):
        ...
        # Get value of stakes (use it as a multiplier when calculating winning
...
class Export:
    ...
    def save_history(self, partner, game_history, game_stats_all):
