...
class Start:
    def __init__(self, parent):
        ...
        self.low_stakes_button_stakes_button = Button(self.stakes_frame, text="Medium ($10)",
                                                      command=lambda: self.to_game(2),
                                                      font=button_font, bg="yellow")
        self.low_stakes_button.grid(row=0, column=1, padx=5, pady=10)
...
class Game:
    def __init__(self, partner, skates, starting_balance):
        print(skates)
